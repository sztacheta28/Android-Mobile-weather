...
import pl.androiddev.weather.utils.CustomFormatter;
import pl.androiddev.weather.utils.XFormatter;
...
public class GraphsFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu , MenuInflater inflater) {
        ...
        this.menu = menu;
        this.menu.getItem(0).setIcon(ContextCompat.getDrawable(getContext() , R.drawable.ic_radio_button_checked_white_24dp));
    }
    ...
    private void startTask() {
        ...
        mDescribable = (ArrayList<WeatherFort.WeatherList>) getArguments().getSerializable(Constants.DESCRIBABLE_KEY);
        function();
    }
    ...
    public void loadTemperatureChart() {
        ...
        temperatureChart.setBackgroundColor(ContextCompat.getColor(getActivity() , R.color.graphBackgroundColor));
        ...
        Description des = temperatureChart.getDescription();
    ...
    public void loadRainChart() {
        ...
        rainChart.setBackgroundColor(ContextCompat.getColor(getActivity() , R.color.graphBackgroundColor));
        ...
        Description des = rainChart.getDescription();
        des.setEnabled(false);
    ...
    public void loadPressureChart() {
        ...
        pressureChart.setBackgroundColor(ContextCompat.getColor(getActivity() , R.color.graphBackgroundColor));
        ...
        Description des = pressureChart.getDescription();
        des.setEnabled(false);
    ...
    public void loadSnowChart() {
        ...
        snowChart.setBackgroundColor(ContextCompat.getColor(getActivity() , R.color.graphBackgroundColor));
        ...
        Description des = snowChart.getDescription();
        des.setEnabled(false);
    ...
    public void loadWindChart() {
        ...
        windChart.setBackgroundColor(ContextCompat.getColor(getActivity() , R.color.graphBackgroundColor));
        ...
        Description des = windChart.getDescription();
        des.setEnabled(false);
